...
public abstract class AbstractQWACValidationTest extends JAdESLevelB2QWACTest {
    ...
    void init() throws Exception {
        documentToSign = new InMemoryDocument(getTLSCertificate().getEncoded(), "TLSCertificate");
    }
    ...
    public void validateQWAC() {
        ...
        assertEquals(Indication.TOTAL_PASSED, simpleReport.getTLSBindingSignatureIndication());
